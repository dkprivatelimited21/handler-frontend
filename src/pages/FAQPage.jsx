      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Returns are not possible for all kinds of products.
              </p>
            </div>
          )}
        </div>
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                everythingfre4200@gmail.com, or by calling us at 8795721727,8881803601 
                between the hours of 12am and 5pm EST, Monday through Friday.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We accept All kinds of UPI methods of payments.
              </p>
            </div>
          )}
        </div>
